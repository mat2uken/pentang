...
#define CORE_ABI_VERSION UINT32_C(1)
#define CORE_MAX_VALUES UINT32_C(4096)

#define CORE_OK INT32_C(0)
#define CORE_ERR_INVALID_ARGUMENT INT32_C(1)
#define CORE_ERR_LIMIT_EXCEEDED INT32_C(2)
#define CORE_ERR_BUFFER_TOO_SMALL INT32_C(3)
