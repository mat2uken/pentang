...
| M4-01 | 採用候補と共通操作を固定 | DONE | 全native+全Web | reports/local/m4-01/run.md、source hash 8件、UI-01〜06固定 | 未commitのためhash識別、test用exportは動作変更なし |
| M4-02 | macOS同梱アプリを検証 | DONE | N-MAC | reports/local/nmac-m4-02/run.md PASS UI-01〜06 | bundle f53c8fa5、Vite停止確認済み |
| M4-03 | iOS Simulatorで検証 | DONE | N-IOS-SIM (75B3..., iPhone 16) | reports/local/ios-sim-m4-03/run.md PASS (UI-03単独はself-test内basicで代替、本文参照) | Sim用.app、install/launch実績 |
| M4-04 | Android Emulatorで検証 | DONE | N-ANDROID-EMU (medium_phone) | reports/local/emu-m4-04/run.md PASS UI-01〜06 | APK 225M、adb -s install |
