...
function usage() {
  return `usage: node scripts/verify-emu-chrome.mjs [--serial emulator-5554 --base / --port 4173 --out docs/reports/local/emu-chrome-wandroid]`;
}
...
const outRel = kv["out"] ?? "docs/reports/local/emu-chrome-wandroid";
